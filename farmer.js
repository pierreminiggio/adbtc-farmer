...
async function startFarming(debugMode = false) {
    ...
    return new Promise(async () => {
        ...
        await page.evaluate((usernameInputSelector, passwordInputSelector) => {
            document.querySelector(usernameInputSelector).value = 'test'
            document.querySelector(passwordInputSelector).value = 'test'
        }, usernameInputSelector, passwordInputSelector)
